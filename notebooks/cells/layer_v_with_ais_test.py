...
Vrest = -70.5366550238 # -70 in ruhemembran
h.celsius = 22.0  # for in vitro opt # 25
...
# Sodium reversal potential calculated on T(295.15K) z(1) x{out}(124mM NaCL + 1.25 mM NaH2Po4 + 26 mM NaH2Co3) x{in}(10 mM Na-phosphocreatine + 0.3 mM Na-GTP)
p_ena = 68.16371 #mV
